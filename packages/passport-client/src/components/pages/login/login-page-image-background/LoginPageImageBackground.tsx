...
export const LoginPageImageBackground: React.FC<Props> = ({
	...
	return (
		<div className="passport-login-page-image-background">
			<div className="passport-login-page-image-background-image-cont">
				<img className="passport-login-page-image-background-main-image"
					 src="/login-background-image-full-width.jpg"/>
			</div>
			<div className="passport-login-page-image-background-input-form">
				...
				<InputForm>
					...
					></Input>
					<div className="passport-login-page-image-background-password-cont">
						<Input
						...
						></Input>
						<button className="passport-login-page-image-background-forgot-password-btn">Forgot Password</button>
					</div>

				</InputForm>
				<div className="passport-login-page-image-background-primary-btn-cont">
					<Button
