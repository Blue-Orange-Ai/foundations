...
import BlueOrangeMedia, {Media} from "../../sdks/media/BlueOrangeMedia";

import './Avatar.css';
import {AvatarEmpty} from "../avatarempty/AvatarEmpty";
import {AvatarImage} from "../avatarimage/AvatarImage";
import {FileUploadBtn} from "../../fileuploadbtn/FileUploadBtn";
import Passport, {PassportAvatar, User} from "../../sdks/passport/Passport";
						...
						<div className="default-avatar-modify-btns">
							...
							{workingUser !== undefined && workingUser.avatar && workingUser.avatar.enabled &&
								<div className="default-avatar-remove-btn">
									<DefaultBtn label={"Remove Avatar"} style={{width: "150px"}} onClick={removeAvatarRequest} isLoading={loadingRemove}></DefaultBtn>
								</div>
							}
						</div>
					</div>
