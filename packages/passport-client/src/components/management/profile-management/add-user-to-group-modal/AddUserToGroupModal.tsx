...
import "./AddUserToGroupModal.css"
...
export const AddUserToGroupModal: React.FC<Props> = ({user, onClose}) => {
	...
	const toggleSelectionState = (groupId:string|undefined, event: React.MouseEvent<HTMLElement>) => {
                ...
                <div className="add-user-group-modal-table-ctrls">
					...
					<div className="default-sml-table-ctrl-btn-right">
						<ButtonIcon
							...
							isDisabled={selectedGroups.length <= 0}></ButtonIcon>
					</div>
				</div>
				{loading &&
					<div>
						...
						<div className="passport-user-group-footer">
							...
							<div className="passport-user-group-footer-right">
								...
								<div className="passport-user-group-table-footer-prev-next-btn">
									<ButtonIcon icon="ri-arrow-left-s-fill" label="Previous Page" isDisabled={workingPage <= 0} onClick={prevPage}></ButtonIcon>
								</div>
								<div className="passport-user-group-table-footer-prev-next-btn">
									<ButtonIcon icon="ri-arrow-right-s-fill" label="Next Page" isDisabled={workingPage + 1 >= Math.ceil(count / workingSize)} onClick={nextPage}></ButtonIcon>
								</div>
							</div>
						</div>
					</div>
