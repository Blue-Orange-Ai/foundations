/**
 * Public types for the Foundations PDF Viewer.
 *
 * The viewer wraps the headless @embedpdf/* engine and plugins and exposes a
 * single high level component (`PdfViewer`) plus an imperative handle
 * (`PdfViewerApi`). All of the underlying feature-set is surfaced either as a
 * prop, a callback, or a method on the imperative handle.
 */
...
export interface PdfViewerProps {
	...
	/* ---- initial view state (uncontrolled) ---- */
