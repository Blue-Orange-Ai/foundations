...
export const PhoneInput: React.FC<Props> = ({
	...
	const countrySelectElem = useRef<HTMLSelectElement>(null);

	const defaultTelephone: Telephone = {
		code: "AU", country: "Australia", extension: "+61", format: "", number: ""
	}

	const inputTelephone: Telephone = telephone === undefined ? defaultTelephone : telephone;

	const getCountryByCode = (code: string) : PhoneCountry => {
